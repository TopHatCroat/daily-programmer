...
I must admit, yesterday's "easy" task was more difficult than this one, eyyy, recursion is hard, amarite?

It's a simple number cruntching puzzle, where and Lodash always comes in very handy with all of it's helpers. Either to validate input or simply to help with it's massive library of functional oriented functions because EcmaScript is not functional enough.  

Description
===========

A Ducci sequence is a sequence of n-tuples of integers, sometimes known as "the Diffy game", because it is based on sequences. Given an n-tuple of integers (a\_1, a\_2, ... a_n) the next n-tuple in the sequence is formed by taking the absolute differences of neighboring integers. Ducci sequences are named after Enrico Ducci (1864-1940), the Italian mathematician credited with their discovery.
...
It's also kind of fun to plot these in 3 dimensions. [Here](https://monkey.org/%7Ejose/graphing/ducci/index2.html) is an example of the sequence "(129,12,155,772,63,4)" turned into 2 sets of lines (x1, y1, z1, x2, y2, z2).
